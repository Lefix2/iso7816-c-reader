    ...
    *receive_length = 0;
    ...
    while (state != APDU_T0_exit){
        ...
        case APDU_T0_Send :
            ...
            common_memcpy(TPDU_buffer, send_buffer, 4);
            TPDU_buffer[P3_IDX] = Nc;

            /* Copy data if there's some */
            common_memcpy(TPDU_buffer + TPDU_HEADER_SIZE, send_buffer + data_offset, Nc);
        ...
        case APDU_T0_Enveloppe :
            ...
            common_memcpy(TPDU_buffer + TPDU_HEADER_SIZE, send_buffer + send_length, P3);
        ...
        case APDU_T0_GetResponse :
            /* When Ne > 255 */
            P3 = MIN(Nx, Ne - *receive_length) == 256 ? 0 : MIN(Nx, Ne - *receive_length);
        ...
        case APDU_T0_Exchange_TPDU :
            ...
            ret=protocol_TPDU_T0.Transact(    context,
                                            TPDU_buffer, snd_len,
                                            buff_addr, &rcv_len
                                         );
            if(ret != sc_Status_Success){
...
protocol_itf_t protocol_APDU_T0 = {
        protocol_APDU_T0_transact
};
